  ...
  return (
    <MainLayout>
      <div className="develop">
        <div>main.scss의 /*** 공통 스타일 ***/ 부분 참조</div>
        ...
        <div className="cntWrapRow">
          ...
          <div style={{ alignItems: "center" }}>
            ...
            <h4>
              자동으로 태그 속 글자 높낮이 가운데 위치 <br /> padding으로 크기
              조절하면 편함
            </h4>
          </div>
        ...
        <div>페이징 컴포넌트 : PageingComponent</div>
        <PageingComponent />
        <hr />
        <div>
          <h3>언어 아이콘들</h3>
